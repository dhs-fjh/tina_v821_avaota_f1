...
function lunch
{
	...
	if [ -e ${TINA_TOPDIR}/openwrt/target/${platform}/${platform}-common/${platform}_select_chip_alter.sh ]; then
		source ${TINA_TOPDIR}/openwrt/target/${platform}/${platform}-common/${platform}_select_chip_alter.sh
		select_chip_alter ${select}
	...
	if [ -e ${TINA_TOPDIR}/openwrt/target/${platform}/${platform}-common/${platform}_select_chip_alter.sh ]; then
		select_chip_alter_action ${select}
	fi
